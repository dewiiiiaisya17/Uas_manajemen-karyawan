...
Route::namespace('Admin')->prefix('admin')->name('admin.')->middleware(['auth','can:admin-access'])->group(function () {
    ...
    // Routes for leaves //
    Route::get('/leaves/list-leaves', 'EmployeeLeaveController@index')->name('leaves.index');
    Route::put('/leaves/{leave_id}', 'EmployeeLeaveController@update')->name('leaves.update');
    // Routes for leaves //
...
Route::namespace('Employee')->prefix('employee')->name('employee.')->middleware(['auth','can:employee-access'])->group(function () {
    ...
    */
    // Routes for Leaves //
    Route::get('/leaves/apply', 'EmployeeLeaveController@create')->name('leaves.create');
    Route::get('/leaves/list-leaves', 'EmployeeLeaveController@index')->name('leaves.index');
    Route::post('/leaves/{employee_id}', 'EmployeeLeaveController@store')->name('leaves.store');
    Route::get('/leaves/edit-leave/{leave_id}', 'EmployeeLeaveController@edit')->name('leaves.edit');
    Route::put('/leaves/{leave_id}', 'EmployeeLeaveController@update')->name('leaves.update');
    Route::delete('/leaves/{leave_id}', 'EmployeeLeaveController@destroy')->name('leaves.delete');
