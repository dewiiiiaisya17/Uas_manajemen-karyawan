                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($employee->attendanceToday)
                                        ...
                                        @endif
                                    @else
                                        <td colspan="4"><h6 class="text-center"><span class="badge badge-pill badge-danger">Belum Ada Riwayat</span></h6></td>
                                    @endif
                                    <td>{{ $employee->attendanceToday->entry_location ?? '-' }}</td>
                                    <td>{{ $employee->desg }}</td>
                                    <td>
                                        @if($employee->attendanceToday)
                                        <button class="btn btn-flat btn-danger" data-toggle="modal" data-target="#deleteModalCenter{{ $employee->attendanceToday->id }}">Hapus Riwayat</button>
                                        @else
                                        Aksi Tidak Tersedia
                                        @endif
                                    </td>
